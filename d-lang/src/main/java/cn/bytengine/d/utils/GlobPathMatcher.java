 ...
 * <li><code>cn/bytengine/&#42;&#42;/*.jsp</code> &mdash; matches all
 * {@code .jsp} files underneath the {@code cn/bytengine} path</li>
 * <li><code>org/&#42;&#42;/servlet/bla.jsp</code> &mdash; matches
 * {@code cn/bytengine/servlet/bla.jsp} but also
 * {@code cn/bytengine/testing/servlet/bla.jsp} and {@code org/servlet/bla.jsp}</li>
...
public class GlobPathMatcher {
    ...
    protected String[] tokenizePath(String path) {
        return CharSequenceTools.tokenizeToStringArray(path, this.pathSeparator, this.trimTokens, true);
    }
    ...
    public String extractPathWithinPattern(String pattern, String path) {
        ...
        String[] pathParts = CharSequenceTools.tokenizeToStringArray(path, this.pathSeparator, this.trimTokens, true);
    ...
    public String combine(String pattern1, String pattern2) {
        if (CharSequenceTools.isEmpty(pattern1) && CharSequenceTools.isEmpty(pattern2)) {
            return "";
        }
        if (CharSequenceTools.isEmpty(pattern1)) {
            return pattern2;
        }
        if (CharSequenceTools.isEmpty(pattern2)) {
            return pattern1;
        }
