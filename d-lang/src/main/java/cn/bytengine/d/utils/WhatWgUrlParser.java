...
import cn.bytengine.d.lang.UriTools;
...
final class WhatWgUrlParser {
    ...
    private WhatWgUrlParser(
            String input, UrlRecord base, Charset encoding,
     ...
     *                             parsable URL
     */
    public static UrlRecord parse(String input, UrlRecord base,
                                  Charset encoding, Consumer<String> validationErrorHandler)
     ...
     */
    private UrlRecord basicUrlParser(UrlRecord url, State stateOverride) {
        // If url is not given:
        if (url == null) {
    ...
    private static LinkedList<String> strictSplit(String input, int delimiter) {
        ...
        while (position != EOF) {
            ...
            AssertTools.isTrue(input.codePointAt(position) == delimiter, "Codepoint is not a delimiter");
    ...
    private void validationError(String additionalInfo) {
    ...
    private void failure(String additionalInfo) {
    ...
    private static String percentDecode(String input) {
        try {
            return UriTools.decode(input, StandardCharsets.UTF_8);
        } catch (IllegalArgumentException ex) {
    ...
    private String percentEncode(int c, IntPredicate percentEncodeSet) {
        if (this.encoding == null) {
            ...
            return percentEncode(Character.toString((char) c), percentEncodeSet);
        }
    }
    ...
    private enum State {
            ...
            public void handle(int c, UrlRecord url, WhatWgUrlParser p) {
                ...
                // Otherwise, if c is U+003A (:), then:
                    ...
                    if (p.stateOverride != null) {
                        ...
                        if (url.port instanceof IntPort) {
                            IntPort intPort = (IntPort) url.port;
                            if (intPort.value() == defaultPort(url.scheme)) {
                                url.port = null;
                                // Return.
                                p.stopMainLoop = true;
                                return;
                    ...
                    // Otherwise, if url is special, base is non-null, and base’s scheme is url’s scheme:
                        ...
                        AssertTools.isTrue(!p.base.path().isOpaque(), "Opaque path not expected");
            ...
            public void handle(int c, UrlRecord url, WhatWgUrlParser p) {
                ...
                if (p.base == null || p.base.path().isOpaque() && c != '#') {
                    p.failure("The input is missing a scheme, because it does not begin with an ASCII alpha \"" +
                            (c != EOF ? Character.toString((char) c) : "") + "\", and no base URL was provided.");
                }
        ...
        RELATIVE {
            ...
            public void handle(int c, UrlRecord url, WhatWgUrlParser p) {
                ...
                AssertTools.isTrue(p.base != null && !"file".equals(p.base.scheme()),
        ...
        RELATIVE_SLASH {
            ...
            public void handle(int c, UrlRecord url, WhatWgUrlParser p) {
                ...
                // and then, decrease pointer by 1.
                    ...
                    AssertTools.isTrue(p.base != null, "No base URL available");
                    url.username = (p.base.username != null) ? new StringBuilder(p.base.username) : null;
                    url.password = (p.base.password != null) ? new StringBuilder(p.base.password) : null;
                    url.host = p.base.host();
                    url.port = p.base.port();
        ...
        AUTHORITY {
            ...
            public void handle(int c, UrlRecord url, WhatWgUrlParser p) {
                ...
                // - url is special and c is U+005C (\)
                    ...
                    if (p.atSignSeen && CharSequenceTools.isEmpty(p.buffer)) {
        ...
        HOST {
            ...
            public void handle(int c, UrlRecord url, WhatWgUrlParser p) {
                ...
                // Otherwise, if c is U+003A (:) and insideBrackets is false, then:
                    ...
                    if (CharSequenceTools.isEmpty(p.buffer)) {
                        p.failure("Missing host.");
                    }
                ...
                // - url is special and c is U+005C (\)
                    ...
                    // host-missing validation error, return failure.
                    if (url.isSpecial() && CharSequenceTools.isEmpty(p.buffer)) {
                    ...
                    else if (p.stateOverride != null && CharSequenceTools.isEmpty(p.buffer) &&
        ...
        PORT {
            ...
            public void handle(int c, UrlRecord url, WhatWgUrlParser p) {
                    ...
                    if (!CharSequenceTools.isEmpty(p.buffer)) {
                        ...
                        if (containsOnlyAsciiDigits(p.buffer)) {
                            try {
                                ...
                                int port = parseInt(p.buffer, 0, p.buffer.length(), 10);
                ...
                // Otherwise, port-invalid validation error, return failure.
                    ...
                    p.failure("Invalid port: \"" + Character.toString((char) c) + "\"");
                }
            }
        },
        FILE {
            ...
            public void handle(int c, UrlRecord url, WhatWgUrlParser p) {
                ...
                // Otherwise:
                    ...
                    if (p.base != null && p.base.scheme.equals("file")) {
                        ...
                        String substring = p.input.substring(p.pointer);
                        if (!startsWithWindowsDriveLetter(substring) && p.base.path instanceof PathSegments) {
                            PathSegments basePath = (PathSegments) p.base.path;
                            if (!basePath.isEmpty() && isWindowsDriveLetter(basePath.get(0), true)) {
        ...
        FILE_HOST {
            ...
            public void handle(int c, UrlRecord url, WhatWgUrlParser p) {
                ...
                if (c == EOF || c == '/' || c == '\\' || c == '?' || c == '#') {
                    ...
                    else if (CharSequenceTools.isEmpty(p.buffer)) {
                        // Set url’s host to the empty string.
                        url.host = EmptyHost.INSTANCE;
                        // If state override is given, then return.
                        if (p.stateOverride != null) {
                    ...
                    // Otherwise, run these steps:
                        ...
                        if (host instanceof Domain) {
                            ...
                            if (domain.domain().equals("localhost")) {
        ...
        QUERY {
            ...
            public void handle(int c, UrlRecord url, WhatWgUrlParser p) {
                ...
                if ((p.stateOverride == null && c == '#') || c == EOF) {
                    ...
                    AssertTools.isTrue(url.query != null, "Url's query should not be null");
        ...
        FRAGMENT {
            ...
            public void handle(int c, UrlRecord url, WhatWgUrlParser p) {
                ...
                if (c != EOF) {
                    ...
                    AssertTools.isTrue(url.fragment != null, "Url's fragment should not be null");
                    if (encoded != null) {
    ...
    static final class UrlRecord {
        ...
        public boolean includesCredentials() {
            return (this.username != null && !CharSequenceTools.isEmpty(this.username) ||
                    this.password != null && !CharSequenceTools.isEmpty(this.password));
        }
    ...
    interface Host {
        ...
        static Host parse(String input, boolean isOpaque, WhatWgUrlParser p) {
            ...
            AssertTools.isTrue(!input.isEmpty(), "Input should not be empty");
        ...
        static boolean endsInNumber(String input) {
    ...
    static final class IpAddressHost implements Host {
        ...
        public boolean equals(Object obj) {
            if (obj == this) {
                return true;
            } else if (obj instanceof IpAddressHost) {
    ...
    static final class OpaqueHost implements Host {
        ...
        public boolean equals(Object obj) {
            if (obj == this) {
                return true;
            } else if (obj instanceof OpaqueHost) {
    ...
    static final class Ipv6Address implements IpAddress {
        ...
        private Ipv6Address(int[] pieces) {
            AssertTools.isTrue(pieces.length == 8, "Invalid amount of IPv6 pieces");
            this.pieces = pieces;
        ...
        public static Ipv6Address parse(String input) {
            ...
            while (c != EOF) {
                ...
                // IPv6-invalid-code-point validation error, return failure.
                    ...
                    throw new InvalidUrlException(
                            "IPv6 address contains \"" + Character.toString((char) c) + "\", which is " +
        ...
        public boolean equals(Object obj) {
            if (obj == this) {
                return true;
            } else if (obj instanceof Ipv6Address) {
    ...
    static final class PathSegment implements Path {
        ...
        public String segment() {
            ...
            if (result == null) {
                AssertTools.isTrue(this.builder != null, "String nor StringBuilder available");
        ...
        public boolean isEmpty() {
            if (this.segment != null) {
                ...
                AssertTools.isTrue(this.builder != null, "String nor StringBuilder available");
                return CharSequenceTools.isEmpty(this.builder);
            }
        }
        ...
        public boolean equals(Object o) {
            if (o == this) {
                return true;
            } else if (o instanceof PathSegment) {
    ...
    static final class PathSegments implements Path {
        ...
        public boolean equals(Object o) {
            if (o == this) {
                return true;
            } else if (o instanceof PathSegments) {
    ...
    private interface ParseIpv4NumberResult {
    }


    private static class ParseIpv4NumberSuccess implements ParseIpv4NumberResult {
        private int number;
        private boolean validationError;

        public ParseIpv4NumberSuccess(int number, boolean validationError) {
            this.number = number;
        ...
        public ParseIpv4NumberSuccess setNumber(int number) {
            this.number = number;
            return this;
        }
        ...
        public ParseIpv4NumberSuccess setValidationError(boolean validationError) {
            this.validationError = validationError;
            return this;
        }
        ...
        public boolean equals(Object o) {
            ...
            ParseIpv4NumberSuccess that = (ParseIpv4NumberSuccess) o;
            return number == that.number && validationError == that.validationError;
        }

        @Override
        public int hashCode() {
            return Objects.hash(number, validationError);
        }

        @Override
        public String toString() {
            return "ParseIpv4NumberSuccess{" +
                    "number=" + number +
