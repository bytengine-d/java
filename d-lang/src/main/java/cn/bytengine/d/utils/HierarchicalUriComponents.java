...
final class HierarchicalUriComponents extends UriComponents {
    ...
    private static final MultiValueMap<String, String> EMPTY_QUERY_PARAMS =
            CollectionTools.unmodifiableMultiValueMap(new LinkedMultiValueMap<>());


    /**
     * Represents an empty path.
     */
    public static final PathComponent NULL_PATH_COMPONENT = new PathComponent() {
        @Override
    ...
    HierarchicalUriComponents(String scheme, String fragment, String userInfo,
        ...
        this.queryParams = query != null ? CollectionTools.unmodifiableMultiValueMap(query) : EMPTY_QUERY_PARAMS;
    ...
    private MultiValueMap<String, String> encodeQueryParams(BiFunction<String, Type, String> encoder) {
        ...
        return CollectionTools.unmodifiableMultiValueMap(result);
    }
    ...
    static String encodeUriComponent(String source, Charset charset, Type type) {
        if (CharSequenceTools.isEmpty(source)) {
            return source;
        }
        AssertTools.notNull(charset, "Charset must not be null");
        AssertTools.notNull(type, "Type must not be null");
        ...
        return CharSequenceTools.copyToString(baos, charset);
    }
    ...
    protected HierarchicalUriComponents expandInternal(UriTemplateVariables uriVariables) {
        AssertTools.isTrue(!this.encodeState.equals(EncodeState.FULLY_ENCODED),
    ...
    public UriComponents normalize() {
        String normalizedPath = PathTools.cleanPath(getPath());
    ...
    public String toUriString() {
        ...
        if (this.userInfo != null || this.host != null) {
            ...
            if (CharSequenceTools.isNotBlank(this.port) && !this.port.equals("-1")) {
    ...
    public URI toUri() {
        try {
            if (this.encodeState.isEncoded()) {
                ...
                String path = getPath();
                if (CharSequenceTools.isNotEmpty(path) && path.charAt(0) != PATH_DELIMITER) {
    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof HierarchicalUriComponents) {
            ...
            return (ObjectTools.nullSafeEquals(getScheme(), that.getScheme()) &&
                    ObjectTools.nullSafeEquals(getUserInfo(), that.getUserInfo()) &&
                    ObjectTools.nullSafeEquals(getHost(), that.getHost()) &&
    ...
    static final class FullPathComponent implements PathComponent {
        ...
        @Override
        public List<String> getPathSegments() {
            String[] segments = CharSequenceTools.tokenizeToStringArray(getPath(), PATH_DELIMITER_STRING);
            return CollectionTools.newLinkedList(segments);
        }
        ...
        public boolean equals(Object other) {
            ...
            if (other instanceof FullPathComponent) {
                ...
                return getPath().equals(fullPathComponent.getPath());
            }
            return false;
        }
    ...
    static final class PathSegmentComponent implements PathComponent {
        ...
        public PathSegmentComponent(List<String> pathSegments) {
            AssertTools.notNull(pathSegments, "List must not be null");
            this.pathSegments = CollectionTools.copy(pathSegments);
        }
        ...
        @Override
        public void copyToUriComponentsBuilder(UriComponentsBuilder builder) {
            builder.pathSegment(CharSequenceTools.toStringArray(getPathSegments()));
        }
    ...
    static final class PathComponentComposite implements PathComponent {
        ...
        public PathComponentComposite(List<PathComponent> pathComponents) {
            AssertTools.notNull(pathComponents, "PathComponent List must not be null");
    ...
    private static class QueryUriTemplateVariables implements UriTemplateVariables {
        ...
        public Object getValue(String name) {
            ...
            if (ArrayTools.isArray(value)) {
                value = ArrayTools.arrayToCommaDelimitedString(ArrayTools.toObjectArray(value));
            }
            return value;
        }
    }
